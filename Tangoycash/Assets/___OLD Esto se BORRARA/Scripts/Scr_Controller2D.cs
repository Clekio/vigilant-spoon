...
public class Scr_Controller2D : MonoBehaviour {
    ...
    [Tooltip("El ángulo máximo de un elemento del escenario que podrá bajar el jugador.")]
    public float AnguloMaxBajada = 80;
    ...
    void DescendSlope(ref Vector3 velocity)
    {
        ...
        {
            float slopeAngle = Vector2.Angle(hit.normal, Vector2.up);
            if (slopeAngle != 0 && slopeAngle <= AnguloMaxBajada)
            {
